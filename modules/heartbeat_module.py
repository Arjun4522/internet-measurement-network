...
class HeartbeatModule(BaseWorker):
    ...
    def _safe_get_user_info(self):
        ...
        try:
            ...
            return {
                ...
                "groups": groups,
                "loadavg": dict(zip(["1m", "5m", "15m"], os.getloadavg()))
    ...
    def _safe_agent_version(self):
        return {}

    def _safe_loaded_modules(self):
        workers = self.agent.manager.running_workers
        return {
            "modules": list(workers.keys()),
            "spec": {worker_name: worker.serializer().schema() for (worker_name, worker) in workers.items() if worker.serializer()}
        }
    ...
    def _get_agent_info(self):
        ...
        return {
            ...
            "modules": self._safe_loaded_modules()
        }
